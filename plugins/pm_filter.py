...
from info import ADMINS, LANGUAGES, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, FILE_REQ_CHANNEL, HOW_TO_DOWNLOAD, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, MSG_ALRT, LOG_CHANNEL, PICS, HS_PICS, SELF_DELETE_SECONDS, SELF_DELETE, LOGIN_CHANNEL, JOIN_PICS, YT_PICS
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                await query.message.edit_text(
                    "ɪ ᴀᴍ ɴᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ᴀɴʏ ɢʀᴏᴜᴩ \nᴄʜᴇᴄᴋ /connections ᴏʀ ᴄᴏɴɴᴇᴄᴛ ᴛɪ ᴀɴʏ ɢʀᴏᴜᴩ",
                    quote=True
                )
                return await query.answer(MSG_ALRT)
