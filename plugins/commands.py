...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('ꜱᴜᴩᴩᴏʀᴛ', url='https://t.me/Hs_Botz'),
        ],[
            InlineKeyboardButton('ꜱᴜᴩᴩᴏʀᴛ ᴍʏ ᴄʜᴀɴɴᴇʟꜱ', url='https://t.me/Flims_hd_official')
        ]]
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>ᴄᴏᴍᴍᴀɴᴅ ɪɴᴄᴏᴍᴘʟᴇᴛᴇ :\n\nɢɪᴠᴇ ᴍᴇ ᴀ ꜱʜᴏʀᴛʟɪɴᴋ ᴀɴᴅ ᴀᴘɪ ᴀʟᴏɴɢ ᴡɪᴛʜ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ !\n\nꜰᴏʀᴍᴀᴛ: <code>/shortlink kpslink.in a33ce12542055ff79361d9bcc681ece612bdcaf8</code></b>")
